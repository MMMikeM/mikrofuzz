...
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    1 |      76 |     0.10 |     1.45 |
| krino (acronym)    |    1 |      76 |     0.10 |     1.54 |
| @nozbe/microfuzz   |    1 |      76 |     1.19 |    10.32 |
| fast-fuzzy         |   13 |      82 |     8.40 |    47.13 |
| Fuse.js            |    1 |      81 |    17.92 |    18.73 |
| fuzzysort          |   20 |      76 |     0.15 |     0.15 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    1 |      19 |     0.08 |     1.43 |
| krino (acronym)    |    1 |      19 |     0.09 |     1.53 |
| @nozbe/microfuzz   |    1 |      36 |     0.95 |    10.08 |
| fast-fuzzy         |    2 |     382 |     7.85 |    46.57 |
| Fuse.js            |    1 |     375 |    11.91 |    12.72 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    1 |       5 |     0.04 |     1.39 |
| krino (acronym)    |    1 |       5 |     0.05 |     1.50 |
| @nozbe/microfuzz   |    1 |       5 |     1.04 |    10.17 |
| fast-fuzzy         |    1 |      95 |    10.41 |    49.13 |
| Fuse.js            |    1 |      95 |    42.49 |    43.30 |
| fuzzysort          |    1 |       5 |     0.12 |     0.12 |
| uFuzzy             |    2 |       5 |     0.15 |     0.15 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    1 |       1 |     0.04 |     1.39 |
| krino (acronym)    |    1 |       1 |     0.04 |     1.48 |
| @nozbe/microfuzz   |    1 |       1 |     1.14 |    10.28 |
| fast-fuzzy         |    1 |     452 |     6.74 |    45.47 |
| Fuse.js            |    1 |     444 |    11.29 |    12.10 |
| fuzzysort          |    1 |       1 |     0.11 |     0.11 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    9 |      80 |     0.18 |     1.53 |
| krino (acronym)    |    9 |      80 |     0.22 |     1.67 |
| @nozbe/microfuzz   |    9 |     116 |     0.97 |    10.10 |
| fast-fuzzy         |   73 |     252 |     8.11 |    46.84 |
| Fuse.js            |    9 |     246 |    11.85 |    12.66 |
| fuzzysort          |   74 |     116 |     0.20 |     0.20 |
| uFuzzy             |    — |       0 |     0.18 |     0.18 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    — |       0 |     0.23 |     1.58 |
| krino (acronym)    |    — |       0 |     0.27 |     1.72 |
| @nozbe/microfuzz   |    9 |     135 |     0.99 |    10.12 |
| fast-fuzzy         |  140 |     495 |     6.90 |    45.63 |
| Fuse.js            |  219 |     486 |    11.33 |    12.14 |
| fuzzysort          |   77 |     135 |     0.22 |     0.22 |
| uFuzzy             |    — |       0 |     0.19 |     0.19 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    — |       0 |     0.21 |     1.56 |
| krino (acronym)    |    — |       0 |     0.27 |     1.72 |
| @nozbe/microfuzz   |   32 |     187 |     0.97 |    10.10 |
| fast-fuzzy         |    ✗ |      22 |     7.02 |    45.74 |
| Fuse.js            |    ✗ |      22 |     7.13 |     7.95 |
| fuzzysort          |   74 |     187 |     0.22 |     0.22 |
| uFuzzy             |    — |       0 |     0.19 |     0.19 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    2 |       8 |     0.21 |     1.56 |
| krino (acronym)    |    1 |       8 |     0.26 |     1.71 |
| @nozbe/microfuzz   |    2 |     133 |     1.15 |    10.28 |
| fast-fuzzy         |    ✗ |      28 |     6.71 |    45.43 |
| Fuse.js            |    ✗ |      28 |     7.41 |     8.22 |
| fuzzysort          |    2 |     133 |     0.20 |     0.20 |
| uFuzzy             |    — |       0 |     0.20 |     0.20 |
...
| Library            | rank | matches | query ms | total ms |
|--------------------|-----:|--------:|---------:|---------:|
| krino (smart)      |    2 |       8 |     0.10 |     1.45 |
| krino (acronym)    |    2 |       8 |     0.13 |     1.57 |
| @nozbe/microfuzz   |    2 |      70 |     0.94 |    10.07 |
| fast-fuzzy         |   33 |      82 |     5.74 |    44.47 |
| Fuse.js            |    1 |      74 |     7.36 |     8.17 |
| fuzzysort          |    2 |      70 |     0.15 |     0.15 |
| uFuzzy             |    — |       0 |     0.21 |     0.21 |
...
Two ledger notes: microfuzz's lazy prep is priced into its index cell as time-to-ready — build + first search, minus one steady-state search of the same query so the cell isolates preparation (index = build + first − second); uFuzzy (latinize)'s index is latinizing the haystack, real preparation that normally hides as "no index".
...
|--------------------|-----:|---------:|---------:|---------:|
| krino (acronym)    | 0.62 |     1.45 |     0.15 |     1.59 |
| @nozbe/microfuzz   | 0.58 |     7.83 |     1.02 |     8.85 |
| krino (smart)      | 0.57 |     1.54 |     0.12 |     1.66 |
| Fuse.js            | 0.57 |     0.81 |    13.99 |    14.80 |
| Fuse.js (all opts) | 0.57 |     0.80 |    17.44 |    18.24 |
| fuzzy              | 0.46 |        — |     2.42 |     2.42 |
| fuzzysort          | 0.39 |        — |     0.16 |     0.16 |
| match-sorter       | 0.31 |        — |     2.96 |     2.96 |
| fast-fuzzy         | 0.28 |    38.73 |     7.21 |    45.94 |
| uFuzzy (latinize)  | 0.26 |     0.60 |     0.19 |     0.79 |
...
| Library            |  MRR | index ms | query ms | total ms |
|--------------------|-----:|---------:|---------:|---------:|
| krino (acronym)    | 0.61 |     1.15 |     0.38 |     1.52 |
| @nozbe/microfuzz   | 0.56 |     7.52 |     1.07 |     8.59 |
| krino (smart)      | 0.54 |     1.34 |     0.30 |     1.64 |
| fuzzy              | 0.39 |        — |     1.85 |     1.85 |
| Fuse.js            | 0.33 |     0.81 |    12.94 |    13.75 |
| Fuse.js (all opts) | 0.33 |     0.82 |    16.51 |    17.33 |
| match-sorter       | 0.23 |        — |     2.76 |     2.76 |
| fuzzysort          | 0.18 |        — |     0.26 |     0.26 |
| fast-fuzzy         | 0.16 |    38.12 |    10.25 |    48.38 |
...
<picture>
  ...
  <img alt="Mixed-corpus accuracy (MRR) vs. query ms with indexes prebuilt, log scale, as a Pareto frontier. The frontier is entirely krino: smart (0.57 at 0.12 ms) to acronym (0.62 at 0.15 ms); every other configuration, including Fuse.js at 0.57 and 14 ms, is dominated." src="./pareto-query-light.svg">
</picture>
...
<picture>
  ...
  <img alt="Mixed-corpus accuracy (MRR) vs. total cost of one cold search (index + one query, log scale) as a Pareto frontier. The frontier runs fuzzysort then krino (acronym), with krino (smart) within noise of it; Fuse.js is dominated: krino (acronym) scores 0.62 at a 1.6 ms total against Fuse's 0.57 at ~15 ms." src="./pareto-total-light.svg">
</picture>
